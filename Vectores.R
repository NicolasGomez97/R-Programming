...
posterior_2005 <-c(FALSE, FALSE, T, T)
...
# crea la puntuación de nico
puntuacion_de_nico <- c(10, 9, 6, 7)

# calcular diferencia entre puntuaciones
puntuacion_de_nico + puntuacion

# calcular la longitud del vector
length(puntuacion_de_nico)

# calcular el promedio del vector puntuacion
mean(puntuacion_de_nico)
